...
75.times{User.create!({username:Faker::Internet.username, password_digest: Faker::Internet.password, email: Faker::Internet.email, gender: Faker::Demographic.sex, race: Faker::Demographic.race, state: Faker::Address.state, city: Faker::Address.city, insurance: Faker::Commerce.brand})}
