...
<Col> 
  ...
  <Card.Title>Our Values</Card.Title>
    ...
    <Card.Text>
         <b>Be Entrepreneurial:</b> To reshape the way the world works, we must be bold and corageous. We forge our own path by challenging the status quo.
    </Card.Text>
    <Card.Text>
        <b>Better Together:</b> We work together with integrity, respect and compassion for one another. We are inclusive, fair and humble while remaining confident. We can make the world better, together.
    </Card.Text>
    <Card.Text>
    ...
    <Card.Title>About GlassMeds</Card.Title>
     <Card.Text>
      GlassMeds was built to increase healthcare cost transparency, offering insights into the patient experience with facilitites (hospital / clinics) acrross the US. All of the information you see here was shared by people who went trhough medical procedures themselves, and ended up with a bill at the end.
    </Card.Text>
